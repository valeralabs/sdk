...
type RosettaBlock struct {
	...
	Metadata *RosettaBlockMetadata `json:"metadata,omitempty"`
}
...
// SetMetadata gets a reference to the given RosettaBlockMetadata and assigns it to the Metadata field.
