...
func (r ApiGetBurnchainRewardListByAddressRequest) Execute() (*BurnchainRewardListResponse, *http.Response, error) {
...
// Execute executes the request
//  @return BurnchainRewardListResponse
func (a *StackingRewardsApiService) GetBurnchainRewardListByAddressExecute(r ApiGetBurnchainRewardListByAddressRequest) (*BurnchainRewardListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
