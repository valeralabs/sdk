...
func (r ApiGetAllNamespacesRequest) Execute() (*BnsGetAllNamespacesResponse, *http.Response, error) {
...
func (a *NamesApiService) GetAllNamespacesExecute(r ApiGetAllNamespacesRequest) (*BnsGetAllNamespacesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BnsGetAllNamespacesResponse
	)
...
func (a *NamesApiService) GetHistoricalZoneFileExecute(r ApiGetHistoricalZoneFileRequest) (*BnsFetchHistoricalZoneFileResponse, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"name"+"}", url.PathEscape(parameterToString(r.name, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"zoneFileHash"+"}", url.PathEscape(parameterToString(r.zoneFileHash, "")), -1)
...
func (a *NamesApiService) GetNamespaceNamesExecute(r ApiGetNamespaceNamesRequest) ([]string, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"tld"+"}", url.PathEscape(parameterToString(r.tld, "")), -1)
