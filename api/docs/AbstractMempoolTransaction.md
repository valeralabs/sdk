...
`func (o *AbstractMempoolTransaction) GetTxId() string`
...
`func (o *AbstractMempoolTransaction) GetSenderAddress() string`
...
`func (o *AbstractMempoolTransaction) SetSponsored(v bool)`
