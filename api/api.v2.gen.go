...
type MempoolTransactionListResponse struct {
	Limit   int                                        `json:"limit"`
	Offset  int                                        `json:"offset"`
	Results []GetMempoolTransactionListResponseResults `json:"results"`
	Total   int                                        `json:"total"`
}
...
type BurnchainRewardSlotHolderListResponse struct {
	Limit   int                                                     `json:"limit"`
	Offset  int                                                     `json:"offset"`
	Results []GetBurnchainRewardSlotHoldersByAddressResponseResults `json:"results"`
	Total   int                                                     `json:"total"`
}
...
type BurnchainRewardListResponse struct {
	Limit   int                                              `json:"limit"`
	Offset  int                                              `json:"offset"`
	Results []GetBurnchainRewardListByAddressResponseResults `json:"results"`
}
