...
func (r ApiPostFeeTransactionRequest) TransactionFeeEstimateRequest(transactionFeeEstimateRequest TransactionFeeEstimateRequest) ApiPostFeeTransactionRequest {
	r.transactionFeeEstimateRequest = &transactionFeeEstimateRequest
	return r
}

func (r ApiPostFeeTransactionRequest) Execute() (*TransactionFeeEstimateResponse, *http.Response, error) {
...
func (a *FeesApiService) PostFeeTransactionExecute(r ApiPostFeeTransactionRequest) (*TransactionFeeEstimateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TransactionFeeEstimateResponse
	)
