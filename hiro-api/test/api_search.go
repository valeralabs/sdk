...
func (r ApiSearchByIdRequest) Execute() (*SearchResult, *http.Response, error) {
...
//  @return SearchResult
func (a *SearchApiService) SearchByIdExecute(r ApiSearchByIdRequest) (*SearchResult, *http.Response, error) {
	var (
	...
	if r.includeMetadata != nil {
		localVarQueryParams.Add("include_metadata", parameterToString(*r.includeMetadata, ""))
	}
