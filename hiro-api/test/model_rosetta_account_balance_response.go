...
type RosettaAccountBalanceResponse struct {
	...
	BlockIdentifier NullableInterface{} `json:"block_identifier"`
...
func (o *RosettaAccountBalanceResponse) GetBlockIdentifier() interface{} {
	if o == nil || o.BlockIdentifier.Get() == nil {
		var ret interface{}
		return ret
	}

	return *o.BlockIdentifier.Get()
}
...
func (o RosettaAccountBalanceResponse) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["block_identifier"] = o.BlockIdentifier.Get()
	}
	if true {
