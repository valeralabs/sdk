...
type RosettaConstructionPreprocessResponse struct {
	...
	RequiredPublicKeys []Object `json:"required_public_keys,omitempty"`
}
...
// SetOptions gets a reference to the given Object and assigns it to the Options field.
...
// SetRequiredPublicKeys gets a reference to the given []Object and assigns it to the RequiredPublicKeys field.
