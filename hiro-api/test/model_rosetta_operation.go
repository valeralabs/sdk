...
type RosettaOperation struct {
	...
	Account *Object `json:"account,omitempty"`
...
func (o *RosettaOperation) GetRelatedOperations() []RosettaRelatedOperation {
	if o == nil || o.RelatedOperations == nil {
...
// SetAccount gets a reference to the given Object and assigns it to the Account field.
...
// SetAmount gets a reference to the given Object and assigns it to the Amount field.
