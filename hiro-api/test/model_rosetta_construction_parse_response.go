...
type RosettaConstructionParseResponse struct {
	...
	AccountIdentifierSigners []Object `json:"account_identifier_signers,omitempty"`
...
// SetAccountIdentifierSigners gets a reference to the given []Object and assigns it to the AccountIdentifierSigners field.
