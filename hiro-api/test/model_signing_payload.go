...
type SigningPayload struct {
	...
	AccountIdentifier *Object `json:"account_identifier,omitempty"`
...
// SetAccountIdentifier gets a reference to the given Object and assigns it to the AccountIdentifier field.
