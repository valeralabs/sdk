...
type RosettaAccountBalanceRequest struct {
	...
	BlockIdentifier *Object `json:"block_identifier,omitempty"`
}
...
// SetBlockIdentifier gets a reference to the given Object and assigns it to the BlockIdentifier field.
